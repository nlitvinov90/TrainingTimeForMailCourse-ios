...
class TrainingsViewController: BaseViewController {
 ...
 //       navigationController?.navigationBar.barTintColor = UIColor(red: 0.071, green: 0.078, blue: 0.086, alpha: 1)
        ...
        tableView.register(TrainingTableViewCell.self, forCellReuseIdentifier: "TrainingTableViewCell")
...
extension TrainingsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "TrainingTableViewCell", for: indexPath) as? TrainingTableViewCell else {
            return .init()
        }
        
        cell.configure(with: trainings[indexPath.section])
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let exer = trainings[indexPath.section]
...
extension TrainingsViewController: TrainingTableViewCellDelegate {
